...
function initialize(win) {
    ...
    log.info('Cloudinary Auto-Updater inicializado, versão atual:', currentVersion);
...
/**
 * Inicia o download da atualização do Cloudinary
 */
async function downloadUpdate() {
    try {
        log.info('📥 Iniciando download da atualização do Cloudinary...');
        ...
        const totalSize = updData.fileSize;
